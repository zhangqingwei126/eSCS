...
function alarmSorts(winId){
	...
	var datas = $("#"+winId).alarmTable('cache');
	var sortDatas = datas.sort(compares());
	$("#"+winId).alarmTable('reload', sortDatas);
}
...
var compares = function (){
	return function (a, b){
		var raisedDate0 = a['raisedDate'];
		if(raisedDate0 instanceof Object){
			raisedDate0 = raisedDate0.time;
		}
		var recoverDate0 = a['recoverDate'];
		if(recoverDate0 instanceof Object){
			recoverDate0 = recoverDate0.time;
		}
		var raisedDate1 = b['raisedDate'];
		if(raisedDate1 instanceof Object){
			raisedDate1 = raisedDate1.time;
		}
		var recoverDate1 = b['recoverDate'];
		if(recoverDate1 instanceof Object){
			recoverDate1 = recoverDate1.time;
		}
		var value1 = recoverDate0;
		var value2 = recoverDate1;
		if(recoverDate0 != null && recoverDate1 != null && recoverDate0 != '0' && recoverDate1 != '0'){
    		//如果复归时间一样判断发生时间
    		if(recoverDate0 == recoverDate1){
    			value1 = raisedDate0;
    			value2 = raisedDate1;
    		}
    	}
    	if((recoverDate0 == null || recoverDate0 == '0') && recoverDate1 != null && recoverDate1 != '0'){
    		value1 = raisedDate0;
			value2 = recoverDate1;
    	}
    	if(recoverDate0 != null && recoverDate0 != '0' && (recoverDate1 == null || recoverDate1 == '0')){
...
function alarmTableaddBeforeRecover(data, tableElement, cols, cachelimit, checked, tableId, returnTr){
    ...
    for(var i in cols){
        ...
        rowTemplate.replace((/\{\{(field)\}\}/g, repData));
    }
